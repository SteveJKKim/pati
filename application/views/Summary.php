		...
		<div class="row">
			<div class="col-lg-12">
				...
				<small>7일간 Tracking System 으로 집계된 내용입니다.</small>
			</div>
		</div><!--/.row-->
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-shopping-cart color-blue"></em>
							<div class="large"><?=number_format($sale[0]['cnt'],0);?></div>
							<div class="text-muted">신 규 주 문</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-money color-orange"></em>
							<div class="large"><?=number_format($sale[0]['price'],0);?></div>
							<div class="text-muted">매 출 금 액</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
							<div class="large"><?=number_format($member[0]['cnt'],0);?></div>
							<div class="text-muted">신 규 가 입</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-red panel-widget ">
						<div class="row no-padding"><em class="fa fa-xl fa-search color-red"></em>
							<div class="large"><?=number_format($clk[0]['clk'],0);?></div>
							<div class="text-muted">클 릭 량</div>
						</div>
					</div>
				</div>
			</div><!--/.row-->
